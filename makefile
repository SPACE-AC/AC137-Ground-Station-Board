#******************************************************************************
# Generated by VisualTeensy V1.5.0 on 27/4/2022 at 16:37
#
# Board              Teensy 4.0
# USB Type           Serial
# CPU Speed          600 MHz
...
LIBS_SHARED      := Adafruit_BME280_Library Adafruit_BNO055 Adafruit_BusIO Adafruit_Unified_Sensor TinyGPSPlus 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := EEPROM SPI SD SdFat Wire LiquidCrystal LiquidCrystal_I2C-1.1.2 Adafruit_LiquidCrystal-1.1.0 
