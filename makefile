#******************************************************************************
# Generated by VisualTeensy V1.5.0 on 21/5/2022 at 13:03
#
# Board              Teensy 4.0
# USB Type           Serial
# CPU Speed          600 MHz
...
TARGET_NAME      := gs_board
BOARD_ID         := TEENSY40

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\Omsin\Documents\Arduino\libraries
LIBS_SHARED      := Adafruit_BME280_Library Adafruit_BNO055 Adafruit_BusIO Adafruit_Unified_Sensor TinyGPSPlus Adafruit_FXAS21002C Adafruit_FXOS8700 Adafruit_AHRS 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := Adafruit_LiquidCrystal-1.1.0 EEPROM LiquidCrystal LiquidCrystal_I2C-1.1.2 SD SdFat SPI Time Wire 
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=155 -DARDUINO_TEENSY40 -DARDUINO=10813
